...
namespace VGameEssentials.Systems.Extensions.Numbers.Ssbytes
{
	/// <summary>
	...
	public static class SsbyteRangeExt
	{
		...
		public static sbyte GetClosestValue(this sbyte source, params sbyte[] values)
		{
			KeyValuePair<sbyte, sbyte>[] differences = [];
			foreach (var value in values)
				differences = differences.Add(new((sbyte)(Math.Max(value, source) - Math.Min(value, source)), value));
